...
#define NECROMONOLITH_SPAWN_INTERVAL (2 SECONDS)
...
#define NECROMONOLITH_CHASE_LEASH_DISTANCE 14
#define NECROMONOLITH_TARGET_ROUTE_LEASH_DISTANCE 9
#define NECROMONOLITH_ROUTE_WINDOW 12
#define NECROMONOLITH_REENGAGE_COOLDOWN (30 SECONDS)
#define NECROMONOLITH_AGGRO_RANGE 12
#define NECROMONOLITH_GUARD_ASSIST_RANGE 12
#define NECROMONOLITH_GUARD_EVERY 6
#define NECROMONOLITH_ROUTE_VALIDATE_EVERY 3
#define NECROMONOLITH_WAVES_PER_REST 3
#define NECROMONOLITH_HOLD_TURF_REFRESH (5 SECONDS)
#define NECROMONOLITH_STUCK_WALL_CLIMB_TICKS 8
#define NECROMONOLITH_WALL_CLIMB_COOLDOWN (20 SECONDS)
#define NECROMONOLITH_WALL_CLIMB_TIME (3 SECONDS)
